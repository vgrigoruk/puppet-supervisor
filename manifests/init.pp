...
class supervisor(
  ...
  $logfile                  = '${boxen::config::logdir}/supervisor/supervisord.log',
  $logfile_maxbytes         = '500MB',
  $logfile_backups          = 10,
  $log_level                = 'info',
  $minfds                   = 1024,
  $minprocs                 = 200,
  $childlogdir              = '${boxen::config::logdir}/supervisor',
  $nocleanup                = false,
  $user                     = undef,
  $umask                    = '022',
  ...
  homebrew::formula { 'supervisor':
    before => Package[$supervisor::params::package],
  }
